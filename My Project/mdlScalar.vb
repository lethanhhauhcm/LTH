Module MdlScalar
    ...
    Public Function IsInCustGrp(ByVal strCustGroupName As String, strCustShortName As String _
        ...
        End If
    End Function
    Public Function IsInVendorGrp(ByVal strVendorGroupName As String, strVendorName As String _
                                , Optional intVendorId As Integer = 0) As Boolean
        If intVendorId <> 0 Then
            Cmd.CommandText = "SELECT top 1 RecId from MISC where Cat='VendorNameInGroup' and Val='" _
            & strVendorGroupName & "' and intVal=" & intVendorId
        Else
            Cmd.CommandText = "SELECT top 1 RecId from MISC where Cat='VendorNameInGroup' and Val='" _
            & strVendorGroupName & "' and Val1='" & strVendorName & "'"
        End If
    ...
    Public Function InsertCustId4AOP(intCustId As Integer, strCity As String) As String
        ...
        Return "insert into [42.117.5.70].AOP.dbo.tblSync_KhachHang (KhachHangID,City) values (" _
            & intCustId & ",'" & strCity & "')"
    End Function
    Public Function InsertVendorId4AOP(intVendorId As Integer, strCity As String) As String
        ...
        Return "insert into [42.117.5.70].AOP.dbo.tblSync_NhaCungUng (NhaCungUngID,City) values (" _
            & intVendorId & ",'" & strCity & "')"
    End Function
    Public Function InsertTcode4AOP(strTourCode As String, strCity As String) As String
        ...
        Return "insert into " & strServerIP & "AOP.dbo.tblSync_TourCode (TourCode,City) values ('" _
            & strTourCode & "','" & strCity & "')"
    End Function
End Module
