Imports LTH.MySharedFunctions
Imports LTH.MySharedFunctionsWzConn
Imports System.IO
...
Module mdlSubAndFunc
    ...
    Public Sub AutoUploadPPD2TransVietVN()
        ...
        On Error Resume Next
        Do While FName <> ""
            If UploadFileToFtp(DDanPPD & FName, "ftp://42.117.5.70/transviet.vn/wwwroot/Upload/", "transviet", "ftp@123456789", "APP") = "True" Then
                Kill(DDanPPD & FName)
    ...
    Public Function GetTsRoeMostUpdated(ByVal dteDOI As Date, strCur As String) As Integer
        ...
        Return ScalarToInt("Forex", "TOP 1 BSR", "where Currency='" & strCur _
                    & "' and Status='OK' and ApplyRoeTo like '%TS%'" _
                    & " and EffectDate <='" & CreateFromDate(dteDOI) _
...
NoImportBill:
    ...
    Public Function ComputeVatPctSfAir() As Boolean
        ...
        ExecuteNonQuerry("Update Tkt set VatPctSf=10, VatAmtSf=0" _
                             & " where ChargeTV=0 and VatPctSf is null" _
                             & " And DOI between '01 Jan 22' and '31 Jan 22 23:59'", Conn)
    ...
    Public Function LoadComboBooker(intCustID As Integer, ByRef cboInput As ComboBox) As Boolean
        Try
            LoadCmb_MSC(cboInput, "Select BookerName as VAL from cwt.dbo.Cwt_Bookers where Status='OK' and CustId=" & intCustID)
        Catch ex As Exception
            LoadCmb_MSC(cboInput, "select distinct fValue as VAL from SIR where fName+status='BOOKEROK' and custID=" & intCustID)
        End Try
        Return True
    End Function
